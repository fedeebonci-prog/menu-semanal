...
('seed-1', 'Milanesas de carne con puré', 'principal', 'carne', 'cena', 'todo_el_anio', 'media', true,
...
('seed-2', 'Milanesas de pollo con ensalada', 'principal', 'pollo', 'ambos', 'todo_el_anio', 'media', true,
...
('seed-3', 'Pollo al horno con papas', 'principal', 'pollo', 'cena', 'todo_el_anio', 'media', true,
...
('seed-8', 'Merluza a la plancha con ensalada', 'principal', 'pescado', 'cena', 'todo_el_anio', 'rapida', true,
...
('seed-9', 'Tortilla de papas', 'principal', 'huevo', 'cena', 'todo_el_anio', 'media', false,
...
('seed-12', 'Wok de pollo y vegetales con arroz', 'principal', 'pollo', 'cena', 'todo_el_anio', 'media', true,
...
('seed-14', 'Revuelto de zapallitos con huevo', 'principal', 'huevo', 'cena', 'verano', 'rapida', false,
...
('seed-16', 'Pechuga de pollo grillada con arroz y brócoli', 'principal', 'pollo', 'almuerzo', 'todo_el_anio', 'rapida', true,
...
('seed-20', 'Bife a la plancha con ensalada', 'principal', 'carne', 'cena', 'todo_el_anio', 'rapida', true,
