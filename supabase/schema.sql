...
create table if not exists public.recipes (
  ...
  high_carb boolean not null default false,
...
insert into public.recipes (id, name, category, protein_type, meal_type, season, difficulty, high_protein, high_carb, light, ingredients, notes, source, created_at) values
('seed-1', 'Milanesas de carne con puré', 'principal_vaca', 'carne', 'cena', 'todo_el_anio', 'media', true, true, false,
...
('seed-2', 'Milanesas de pollo con ensalada', 'principal_pollo', 'pollo', 'ambos', 'todo_el_anio', 'media', true, false, false,
...
('seed-3', 'Pollo al horno con papas', 'principal_pollo', 'pollo', 'cena', 'todo_el_anio', 'media', true, true, false,
...
('seed-4', 'Guiso de lentejas', 'guiso', 'legumbre', 'cena', 'invierno', 'media', false, true, false,
...
('seed-5', 'Tarta de acelga y ricota', 'tarta', 'vegetariano', 'ambos', 'todo_el_anio', 'media', false, true, false,
...
('seed-6', 'Fideos con salsa bolognesa', 'pasta', 'pasta', 'ambos', 'todo_el_anio', 'rapida', true, true, false,
...
('seed-7', 'Ensalada César con pollo', 'ensalada', 'pollo', 'almuerzo', 'verano', 'rapida', true, false, true,
...
('seed-8', 'Merluza a la plancha con ensalada', 'principal_pescado', 'pescado', 'cena', 'todo_el_anio', 'rapida', true, false, true,
...
('seed-9', 'Tortilla de papas', 'principal_veggie', 'huevo', 'cena', 'todo_el_anio', 'media', false, true, false,
  '[{"name":"Huevos","quantity":"6 unidades"},{"name":"Papas","quantity":"500 g"},{"name":"Cebolla","quantity":"1 unidad"}]', '', 'manual', '2026-01-01'),
('seed-10', 'Locro', 'guiso', 'carne', 'cena', 'invierno', 'elaborada', true, true, false,
...
('seed-11', 'Ensalada de fideos fría con atún', 'ensalada', 'pasta', 'almuerzo', 'verano', 'rapida', true, true, false,
...
('seed-12', 'Wok de pollo y vegetales con arroz', 'principal_pollo', 'pollo', 'cena', 'todo_el_anio', 'media', true, true, false,
...
('seed-13', 'Hamburguesas caseras con ensalada', 'sandwich', 'carne', 'cena', 'todo_el_anio', 'media', true, false, false,
...
('seed-14', 'Revuelto de zapallitos con huevo', 'principal_veggie', 'huevo', 'cena', 'verano', 'rapida', false, false, true,
...
('seed-15', 'Ñoquis con salsa', 'pasta', 'pasta', 'cena', 'todo_el_anio', 'rapida', false, true, false,
...
('seed-16', 'Pechuga de pollo grillada con arroz y brócoli', 'principal_pollo', 'pollo', 'almuerzo', 'todo_el_anio', 'rapida', true, true, false,
...
('seed-17', 'Ensalada de garbanzos', 'ensalada', 'legumbre', 'almuerzo', 'verano', 'rapida', false, true, true,
...
('seed-18', 'Carbonada', 'guiso', 'carne', 'cena', 'invierno', 'elaborada', true, true, false,
...
('seed-19', 'Sopa de verduras con pollo', 'sopa', 'pollo', 'cena', 'invierno', 'media', false, false, true,
...
('seed-20', 'Bife a la plancha con ensalada', 'principal_vaca', 'carne', 'cena', 'todo_el_anio', 'rapida', true, false, true,
...
('seed-21', 'Pizza casera', 'pizza', 'otro', 'cena', 'todo_el_anio', 'media', false, true, false,
